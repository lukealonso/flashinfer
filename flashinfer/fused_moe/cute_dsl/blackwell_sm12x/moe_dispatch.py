...
def _dynamic_task_geometry(
    state_E: int, n: int, routed_rows: int, *, tile_n: int = _LEVEL_TILE_N
):
...
def allocate_sm120_dynamic_workspace(
    *,
    ...
    physical_tiles, _, max_tasks = _dynamic_task_geometry(
        state_E, n, routed_rows, tile_n=_level_tile_n(activation_precision)
    )
...
def _get_dynamic_kernel(
    ...
    *,
    ...
    mma_tiler_mn = (_LEVEL_TILE_M, _level_tile_n(activation_precision))
